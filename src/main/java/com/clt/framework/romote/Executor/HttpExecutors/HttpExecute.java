package com.clt.framework.romote.Executor.HttpExecutors;

import com.clt.framework.romote.common.FormFile;
...
public class HttpExecute {
    ...
    public HttpExecute(String charSet) {
        ...
        if (params != null && !params.isEmpty()) {
            ...
            for (Map.Entry<String, String> entry : entrys) {
                buf.append(entry.getKey()).append("=")
                        .append(URLEncoder.encode(entry.getValue(), defaultContentEncoding))
                        .append("&");
            }
     ...
     * @param files  上传文件
     */
    public static InputStream uploadFiles(String path, Map<String, String> params, FormFile[] files) throws Exception {
     ...
     * @param file   上传文件
     */
    public  InputStream uploadFile(String path, Map<String, String> params, FormFile file) throws Exception {
    ...
    public static void main(String args[]) throws Exception {
        ...
        HttpExecute httpExecute = new HttpExecute("UTF-8");

        HttpURLConnection conn = (HttpURLConnection)
                httpExecute.sendGetRequest(
                        "http://www.baidu.com",
                        null, null);
        int code = conn.getResponseCode();
        InputStream in = conn.getInputStream();
     //   byte[] data = read2Byte(in);
        System.out.println(read2String(in));
